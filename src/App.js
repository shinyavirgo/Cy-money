  ...
  return (
    <div className="w-full h-[100dvh] bg-gray-200 flex justify-center font-sans overflow-hidden">
      ...
      <div className="w-full max-w-md bg-gray-50 relative flex flex-col h-full shadow-2xl overflow-hidden">
        ...
        {/* ========================================== */}
        <div className="fixed bottom-0 left-0 w-full bg-white border-t border-gray-200 px-6 pt-2 pb-[max(0.5rem,env(safe-area-inset-bottom))] grid grid-cols-3 place-items-center z-50 shadow-[0_-4px_20px_rgba(0,0,0,0.05)]">
